...
class Review(models.Model):
    ...
    stars =models.CharField(max_length=16, choices=[(i, str(i)) for i in range(1,6)], null=True, blank=True)
...
class Booking(models.Model):
    ...
    def __str__(self):
        return f'{self.user_book},{self.status_book},{self.hotel_book},{self.room_book}'
